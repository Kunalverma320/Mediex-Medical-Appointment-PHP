...
<head>
    ...
    <title>Mediax - Health & Medical HTML Template - 404 - Error Page</title>
        ...
        <div class="container">
            ...
            <div class="error-content">
                ...
                <p class="error-text">Oops! The page you are looking for does not exist. It might have been moved or
                    deleted. Please check and try again.</p><a href="index.php" class="th-btn"><i
                        class="fal fa-home me-2"></i>Back To Home</a>
            </div>
        </div>
    </section>
