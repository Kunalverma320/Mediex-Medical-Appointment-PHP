...
<head>
    ...
    <title>Mediax - Health & Medical HTML Template - Blog Details</title>
                ...
                <div class="col-xxl-8 col-lg-7">
                    <div class="th-blog blog-single">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta"><a class="author" href="blog.php"><i class="fal fa-user"></i>By
                                    Mediax</a> <a href="blog.php"><i class="fal fa-calendar"></i>21 June, 2024</a> <a
                                    href="blog-details.php"><i class="fal fa-comments"></i>Comments (3)</a></div>
                            <h2 class="blog-title">How Business Is Taking Over & What to Do About It</h2>
                            <p>We offer flexible appointment scheduling options to accommodate your busy lifestyle.
                                Whether you prefer to book in advance or need a same-day appointment, we strive to make
                                the process as seamless as possible.</p>
                            <p>Especially in light of the ongoing COVID-19 pandemic, we maintain rigorous safety
                                protocols and hygiene standards to ensure the well-being of our patients and staff. Your
                                health and safety are our utmost priority.</p>
                            <blockquote>
                                <p>Choose organic food, not only for a healthier you but for a happier planet too. It's
                                    a conscious choice that nourishes both body and Earth.</p><cite>Michel Clarck</cite>
                            </blockquote>
                            <div class="row pt-2 mt-5">
                                <div class="col-md-6 mb-4"><img class="w-100 rounded-20"
                            ...
                            <p class="mb-4">Our clinic is equipped with modern facilities and advanced medical
                                technology to ensure accurate diagnoses and effective treatments. This enables us to
                                provide you with the highest standard of care.</p>
                            <div class="checklist mb-25">
                                <ul>
                                    <li><i class="fas fa-check-circle"></i> That extremely painful or again is there
                                        anyone.</li>
                                    <li><i class="fas fa-check-circle"></i> Indignation and dislike men who are so
                                        beguiled and demoralized.</li>
                                    <li><i class="fas fa-check-circle"></i> Desires these cases are perfectly simple
                                        easy distinguish.</li>
                                    <li><i class="fas fa-check-circle"></i> That extremely painful or again that is
                                        there anyone.</li>
                                </ul>
                            </div>
                            <p class="mb-n2">From primary care and pediatrics to specialized services like dermatology,
                                orthopedics, and women's health, we offer a wide spectrum of medical services under one
                                roof.</p>
                            <div class="share-links clearfix">
                                <div class="row justify-content-between">
                                    <div class="col-sm-auto"><span class="share-links-title">Tags:</span>
                                        <div class="tagcloud"><a href="blog.php">Medical</a> <a
                                                href="blog.php">Renovations</a></div>
                                    </div>
                            ...
                            <li class="th-comment-item">
                                <div class="th-post-comment">
                                    ...
                                    <div class="comment-content"><span class="commented-on"><i
                                                class="fal fa-calendar"></i>14 March, 2023</span>
                                        ...
                                        <div class="reply_and_edit"><a href="blog-details.php" class="reply-btn"><i
                                    ...
                                    <li class="th-comment-item">
                                        <div class="th-post-comment">
                                            <div class="comment-avater"><img src="assets/img/blog/comment-author-2.jpg"
                                                    alt="Comment Author"></div>
                                            <div class="comment-content"><span class="commented-on"><i
                                                        class="fal fa-calendar"></i>15 March, 2023</span>
                                                ...
                                                <p class="text">We understand that every patient is unique, and their
                                                    ...
                                                    treatment plans.</p>
                                                <div class="reply_and_edit"><a href="blog-details.php"
                            ...
                            <li class="th-comment-item">
                                <div class="th-post-comment">
                                    <div class="comment-avater"><img src="assets/img/blog/comment-author-3.jpg"
                                            alt="Comment Author"></div>
                                    <div class="comment-content"><span class="commented-on"><i
                                                class="fal fa-calendar"></i>16 March, 2023</span>
                ...
                <div class="col-xxl-4 col-lg-5">
                    <aside class="sidebar-area">
                        ...
                        <div class="widget widget_categories">
                            ...
                            <ul>
                                <li><a href="blog.php">Cardiology</a></li>
                                <li><a href="blog.php">Gastroenterologist</a></li>
                                <li><a href="blog.php">Dental Care</a></li>
                                <li><a href="blog.php">Ophthalmology</a></li>
                                <li><a href="blog.php">Orthopedics</a></li>
                                <li><a href="blog.php">Plastic Surgeons</a></li>
                                <li><a href="blog.php">Neurology</a></li>
                            </ul>
                        </div>
                        <div class="widget">
                                ...
                                <div class="recent-post">
                                    ...
                                    <div class="media-body">
                                        <h4 class="post-title"><a class="text-inherit"
                                                href="blog-details.php">Preserving Care Strategy Amidst Food
                                                Changes</a></h4>
                                        <div class="recent-post-meta"><a href="blog.php"><i
                                                    class="fal fa-calendar"></i>23 Jun, 2024</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="widget widget_tag_cloud">
                            ...
                            <div class="tagcloud"><a href="blog.php">Skin Care</a> <a href="blog.php">Advice</a> <a
                                    href="blog.php">Solution</a> <a href="blog.php">Doctors</a> <a
                                    href="blog.php">Medical</a> <a href="blog.php">Hospital</a></div>
                        </div>
                    </aside>
                </div>
            </div>
