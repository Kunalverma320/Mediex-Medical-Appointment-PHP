    ...
    <div class="hero-inner">
        <div class="container">
            <div class="hero-style2">
                <span class="sub-title"><img src="assets/img/theme-img/title_icon.svg" alt="shape" />24/7
                ...
                <div class="btn-group justify-content-center">
                    <a href="about.php" class="th-btn">Discover More</a>
                    <a href="service.php" class="th-btn style4">See All Services</a>
                </div>
            </div>
        </div>
        <div class="hero-img">
            ...
            <div class="col-xl-6">
                <div class="ps-xxl-4 ms-xl-2 text-center text-xl-start">
                    <div class="title-area mb-32">
                        <span class="sub-title"><img src="assets/img/theme-img/title_icon.svg" alt="shape" />About Us
                            Company</span>
                    ...
                    <div class="mb-30 mt-n1">
                        <div class="checklist style2 list-two-column">
                            <ul>
                                <li>
                                    <i class="fas fa-heart-pulse"></i> Medical Professionals
                                </li>
                                <li>
                                    <i class="fas fa-heart-pulse"></i> Facilities and
                                    Equipment
                                </li>
                                <li><i class="fas fa-heart-pulse"></i> Emergency Care</li>
                                <li>
                                    <i class="fas fa-heart-pulse"></i> Medical Consulting
                                </li>
                    ...
                    <div><a href="about.php" class="th-btn">More About Us</a></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row gy-4 justify-content-center">
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="service-card" data-bg-src="assets/img/service/service_card_1.jpg">
                    ...
                    <h3 class="box-title">
                        <a href="service-details.php">Internal Medicine</a>
                    </h3>
                    <p class="box-text">30+ Doctors</p>
                    <a href="service-details.php" class="th-btn btn-sm style2 theme-color">Read More</a>
                </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="service-card" data-bg-src="assets/img/service/service_card_2.jpg">
                    ...
                    <h3 class="box-title">
                        <a href="service-details.php">Dental Care</a>
                    </h3>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="service-card" data-bg-src="assets/img/service/service_card_3.jpg">
                    ...
                    <h3 class="box-title">
                        <a href="service-details.php">Urology Care</a>
                    </h3>
                    <p class="box-text">20+ Doctors</p>
                    <a href="service-details.php" class="th-btn btn-sm style2 theme-color">Read More</a>
                </div>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="service-card" data-bg-src="assets/img/service/service_card_4.jpg">
                    ...
                    <h3 class="box-title">
                        <a href="service-details.php">Neurology Care</a>
                    </h3>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="service-card" data-bg-src="assets/img/service/service_card_5.jpg">
                    ...
                    <h3 class="box-title">
                        <a href="service-details.php">Gynecologists</a>
                    </h3>
                    <p class="box-text">30+ Doctors</p>
                    <a href="service-details.php" class="th-btn btn-sm style2 theme-color">Read More</a>
                </div>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="service-card" data-bg-src="assets/img/service/service_card_6.jpg">
                    ...
                    <h3 class="box-title">
                        <a href="service-details.php">Ophthalmology</a>
                    </h3>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="service-card" data-bg-src="assets/img/service/service_card_7.jpg">
                    ...
                    <h3 class="box-title">
                        <a href="service-details.php">Orthopedics</a>
                    </h3>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="service-card" data-bg-src="assets/img/service/service_card_8.jpg">
                    ...
                    <h3 class="box-title">
                        <a href="service-details.php">Cardiology</a>
                    </h3>
                    <p class="box-text">20+ Doctors</p>
                    <a href="service-details.php" class="th-btn btn-sm style2 theme-color">Read More</a>
                </div>
        ...
        <div class="mt-5 pt-2 space-extra-bottom">
            <p class="round-text">
                <span class="text">You Get Our 20+ More services...
                    <a href="service.php" class="line-btn">Explore All Services</a></span>
            </p>
        </div>
    </div>
</section>
    ...
    <div class="container z-index-common">
        <div class="row align-items-end justify-content-center text-center text-xl-start">
            <div class="col-xl-7 col-lg-9 space-extra">
                ...
                <div class="btn-group justify-content-center">
                    <a href="contact.php" class="th-btn shadow-1">Book Appointment</a>
                    <a href="contact.php" class="th-btn style2 shadow-1">Get Free Consulting</a>
                </div>
            </div>
            <div class="col-xl-5">
                <div class="img-box2">
...
<section class="bg-top-center space-top" id="team-sec" data-bg-src="assets/img/bg/team_bg_1.jpg">
    <div class="container z-index-common">
        <div class="title-area text-center">
            <span class="sub-title"><img src="assets/img/theme-img/title_icon.svg" alt="Icon" />Expert
                doctors</span>
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="th-team team-card">
                        ...
                        <h3 class="box-title">
                            <a href="team-details.php">Dr. Malcolm Function</a>
                        </h3>
                ...
                <div class="swiper-slide">
                    <div class="th-team team-card">
                        ...
                        <h3 class="box-title">
                            <a href="team-details.php">Dr. Douglas Lyphe</a>
                        </h3>
                ...
                <div class="swiper-slide">
                    <div class="th-team team-card">
                        ...
                        <h3 class="box-title">
                            <a href="team-details.php">Dr. Wisteria Ravenc</a>
                        </h3>
                ...
                <div class="swiper-slide">
                    <div class="th-team team-card">
                        ...
                        <h3 class="box-title">
                            <a href="team-details.php">Dr. Benjamin Evalent</a>
                        </h3>
                ...
                <div class="swiper-slide">
                    <div class="th-team team-card">
                        ...
                        <h3 class="box-title">
                            <a href="team-details.php">Dr. Rishita Rosei</a>
                        </h3>
                        <span class="team-desig">Neurologist</span>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="th-team team-card">
                        ...
                        <h3 class="box-title">
                            <a href="team-details.php">Dr. Emanuyel Mac</a>
                        </h3>
                        <span class="team-desig">Physiotherapist</span>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="th-team team-card">
                        ...
                        <h3 class="box-title">
                            <a href="team-details.php">Dr. Wilium Lily</a>
                        </h3>
                        <span class="team-desig">Cardiologist</span>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="th-team team-card">
                        ...
                        <h3 class="box-title">
                            <a href="team-details.php">Dr. Esabel Macran</a>
                        </h3>
                        <span class="team-desig">Dentist</span>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="appointment-row">
            ...
            <div class="form-wrap">
                ...
                <form  id="appointment-form_new" class="appointment-form">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12">
                            <input type="email" class="form-control" name="email" id="email_new"
...
<section class="space" data-bg-src="assets/img/bg/process_bg_1.jpg">
    <div class="container">
        <div class="title-area text-center">
            <span class="sub-title"><img src="assets/img/theme-img/title_icon.svg" alt="Icon" />Work
                Process</span>
                ...
                <div class="pe-xl-4 space-top pt-xl-0 pb-40 pb-xl-0">
                    <div class="title-area text-center text-xl-start">
                        <span class="sub-title"><img src="assets/img/theme-img/title_icon_2.svg"
                                alt="Icon" />Faqs</span>
                        <h2 class="sec-title text-white">
                            Frequently Asked Have<br />Any Question?
                        </h2>
                    </div>
    ...
    <div class="container">
        <div class="row justify-content-lg-between justify-content-center align-items-center">
            ...
            <div class="col-lg-auto d-none d-lg-block">
                <div class="sec-btn">
                    <a href="blog.php" class="th-btn style4">View All Post</a>
                </div>
            </div>
        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="blog-card">
                            ...
                            <div class="blog-content">
                                <div class="blog-meta">
                                    <a href="blog.php"><i class="fal fa-user"></i>By Mediax</a>
                                    <a href="blog.php"><i class="fal fa-calendar"></i>15 March, 2024</a>
                                </div>
                                <h3 class="box-title">
                                    <a href="blog-details.php">How Business Is Taking Over & What to Do About It</a>
                                </h3>
                                <a href="blog-details.php" class="th-btn btn-sm">Read More</a>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="blog-card">
                            ...
                            <div class="blog-content">
                                <div class="blog-meta">
                                    <a href="blog.php"><i class="fal fa-user"></i>By Mediax</a>
                                    <a href="blog.php"><i class="fal fa-calendar"></i>16 March, 2024</a>
                                </div>
                                <h3 class="box-title">
                                    <a href="blog-details.php">Health vs. Wealth Navigate Business in Medicine</a>
                                </h3>
                                <a href="blog-details.php" class="th-btn btn-sm">Read More</a>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="blog-card">
                            ...
                            <div class="blog-content">
                                <div class="blog-meta">
                                    <a href="blog.php"><i class="fal fa-user"></i>By Mediax</a>
                                    <a href="blog.php"><i class="fal fa-calendar"></i>17 March, 2024</a>
                                </div>
                                <h3 class="box-title">
                                    <a href="blog-details.php">Preserving Care Strategy Amidst Food Changes</a>
                                </h3>
                                <a href="blog-details.php" class="th-btn btn-sm">Read More</a>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="blog-card">
                            ...
                            <div class="blog-content">
                                <div class="blog-meta">
                                    <a href="blog.php"><i class="fal fa-user"></i>By Mediax</a>
                                    <a href="blog.php"><i class="fal fa-calendar"></i>19 March, 2024</a>
                                </div>
                                <h3 class="box-title">
                                    <a href="blog-details.php">Healthcare Tips Navigating Business & Patient Care</a>
                                </h3>
                                <a href="blog-details.php" class="th-btn btn-sm">Read More</a>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="blog-card">
                            ...
                            <div class="blog-content">
                                ...
                                <h3 class="box-title">
                                    <a href="blog-details.php">Strategies Against Corporate Intrusion in Healthcare</a>
                                </h3>
                                <a href="blog-details.php" class="th-btn btn-sm">Read More</a>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="blog-card">
                            ...
                            <div class="blog-content">
                                ...
                                <h3 class="box-title">
                                    <a href="blog-details.php">Transform Your Nutrition with Organic Meal</a>
                                </h3>
                                <a href="blog-details.php" class="th-btn btn-sm">Read More</a>
                            </div>
                        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#appointment-form_new').submit(function(e) {
            e.preventDefault();
