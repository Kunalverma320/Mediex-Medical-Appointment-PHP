            ...
            <div class="widget_shopping_cart_content">
                <ul class="woocommerce-mini-cart cart_list product_list_widget">
                    <li class="woocommerce-mini-cart-item mini_cart_item">
                        ...
                        <a href="#"><img src="assets/img/product/product_thumb_1_1.jpg" alt="Cart Image" />Surgery Hands
                            Gloves</a>
                    ...
                    <li class="woocommerce-mini-cart-item mini_cart_item">
                        <a href="#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                        <a href="#"><img src="assets/img/product/product_thumb_1_2.jpg" alt="Cart Image" />D-Ribose Drug
                            Medicine</a>
                        <span class="quantity">1 ×
                            <span class="woocommerce-Price-amount amount"><span
                    ...
                    <li class="woocommerce-mini-cart-item mini_cart_item">
                        <a href="#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                        <a href="#"><img src="assets/img/product/product_thumb_1_3.jpg" alt="Cart Image" />CAD Dentistry
                            Prosthesis</a>
                        <span class="quantity">1 ×
                            <span class="woocommerce-Price-amount amount"><span
                    ...
                    <li class="woocommerce-mini-cart-item mini_cart_item">
                        <a href="#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                        <a href="#"><img src="assets/img/product/product_thumb_1_4.jpg" alt="Cart Image" />Surgery
                            Safety Mask</a>
                        <span class="quantity">1 ×
                            <span class="woocommerce-Price-amount amount"><span
                    ...
                    <li class="woocommerce-mini-cart-item mini_cart_item">
                        <a href="#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                        <a href="#"><img src="assets/img/product/product_thumb_1_5.jpg" alt="Cart Image" />Infrared
                            Thermometers</a>
                        <span class="quantity">1 ×
                            <span class="woocommerce-Price-amount amount"><span
...
<div class="sidemenu-wrapper sidemenu-info mainrun">
    <div class="sidemenu-content">
        <button class="closeButton sideMenuCls">
            <i class="far fa-times"></i>
        </button>
        <div class="widget">
            <div class="th-widget-about">
                <div class="about-logo">
                    <a href="index.php"><img src="assets/img/logo.svg" alt="Mediax" /></a>
                </div>
                <p class="about-text">
                ...
                <p class="footer-info">
                    <i class="fal fa-location-dot"></i> 2478 Street City Ohio 90255
                </p>
                <p class="footer-info">
        ...
        <div class="widget">
            ...
            <div class="newsletter-widget">
                ...
                <form id="new-subscribe" class="newsletter-form">
                ...
                <div class="row" id="message-form-new" style="color:red;"></div>
                ...
                <div class="btn-group">
                    <a href="https://play.google.com/" class="img-btn"><img src="assets/img/normal/apple_store.png"
                            alt="icon" /> </a><a href="https://play.google.com/" class="img-btn"><img
                            src="assets/img/normal/play_store.png" alt="icon" /></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <ul>
                <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                        ...
                        <!-- <li><a href="home-dental-care.php">Dental Care</a></li>
                        <li><a href="home-medical-shop.php">Medical Shop</a></li> -->
                    </ul>
                </li>
                    ...
                    <div class="header-links">
                        <ul>
                            <li class="d-none d-sm-inline-block">
                                <i class="fas fa-phone icon-btn"></i><b>Phone:</b>
                                <a href="tel:+1636543569">+163-654-3569</a>
                            </li>
                            <li class="d-none d-sm-inline-block">
                                <i class="fas fa-envelope icon-btn"></i><b>Email:</b>
                                <a href="mailto:info@mediax.com">info@mediax.com</a>
                            </li>
                            <li class="d-none d-xxl-inline-block">
                                <i class="fas fa-location-dot icon-btn"></i> 1 Barnes Jewish
                                Hospital Plaza, United States
                            </li>
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="dropdown-link">
                                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink1"
                                        data-bs-toggle="dropdown" aria-expanded="true"><img
                                            src="assets/img/icon/english.png" alt="icon" />
                                        English</a>
                ...
                <div class="row align-items-center justify-content-between">
                        ...
                        <nav class="main-menu d-none d-lg-inline-block">
                            <ul>
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li>
                                            <a href="index.php">Medical Clinic</a>
                                        </li>
                                        <!-- <li><a href="home-dental-care.php">Dental Care</a></li>
                                        <li>
                                            <a href="home-medical-shop.php">Medical Shop</a>
                                        </li> -->
                                    </ul>
                                </li>
                                <li><a href="about.php">About Us</a></li>
                    ...
                    <div class="col-auto">
                        <div class="header-button">
                            <button type="button" class="icon-btn searchBoxToggler d-none d-xl-inline-block">
                            ...
                            <a href="appointment.php" class="th-btn">Appointment Now</a>
    ...
    $(document).ready(function(e){
       $("#new-subscribe").submit(function(){
        ...
        $.ajax({
            ...
            {
                // $("#message-form-new").text(data);
                // $(".mainrun").addClass(" show");
                alert(data);
