...
<!-- Mirrored from html.themeholy.com/mediax/demo/home-medical-shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Feb 2024 10:30:00 GMT -->
...
<body>
                    ...
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto d-inline-block d-lg-none">
                            <div class="header-logo"><a href="index.php"><img
                                        src="assets/img/logo-white.svg" alt="Mediax"></a></div>
                        </div>
                        <div class="col-auto ms-auto">
                            <div class="header-button">
                                <div class="dropdown-link d-none d-lg-inline-block"><a class="dropdown-toggle" href="#"
                                        role="button" id="dropdownMenuLink1" data-bs-toggle="dropdown"
                                        aria-expanded="true"><img src="assets/img/icon/english.png" alt="icon">
                                        English</a>
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                        <li><a href="#">German</a> <a href="#">French</a> <a href="#">Italian</a> <a
                                                href="#">Latvian</a></li>
                                    </ul>
                                </div><button type="button" class="icon-btn sideMenuCart"><span class="badge">5</span>
                                    <i class="fal fa-cart-shopping"></i></button> <a href="wishlist.html"
                                    class="icon-btn d-none d-lg-inline-block"><span class="badge">3</span> <i
                                        class="fal fa-heart"></i> </a><button type="button"
                                    class="icon-btn sideMenuInfo d-none d-lg-inline-block"><i
                                        class="fal fa-bars"></i></button> <button type="button"
    ...
    <div class="th-hero-wrapper hero-1" id="hero" data-bg-src="assets/img/hero/hero_bg_1_1.jpg">
            ...
            <div class="swiper-wrapper">
                    ...
                    <div class="hero-inner">
                        <div class="container">
                            <div class="hero-style1"><span class="hero-subtitle" data-ani="slideinup"
                                    data-ani-delay="0.2s">100% Premium Quality Products</span>
                                ...
                                <p class="hero-text" data-ani="slideinup" data-ani-delay="0.5s">Using a 5 layers
                                    surgical mask, we can protect ourselves from various germs. Everyone should use this
                                    5 layers surgical mask.</p><a href="about.html" class="th-btn style4"
                                    data-ani="slideinup" data-ani-delay="0.6s"><i
                ...
                <div class="swiper-slide">
                    <div class="hero-inner">
                        <div class="container">
                            <div class="hero-style1"><span class="hero-subtitle" data-ani="slideinup"
                                    data-ani-delay="0.2s">100% Premium Imported Products</span>
                                <h1 class="hero-title" data-ani="slideinup" data-ani-delay="0.3s">Surgery Hand Gloves
                                </h1>
                                <h2 class="hero-heading" data-ani="slideinup" data-ani-delay="0.4s">Get <span
                                        class="text-theme">25%</span> Off, Hurry Up!</h2>
                                <p class="hero-text" data-ani="slideinup" data-ani-delay="0.5s">Using a 5 layers
                ...
                <div class="swiper-slide">
                    <div class="hero-inner">
                        <div class="container">
                            <div class="hero-style1"><span class="hero-subtitle" data-ani="slideinup"
                                    data-ani-delay="0.2s">100% Premium Quality Products</span>
                                <h1 class="hero-title" data-ani="slideinup" data-ani-delay="0.3s">Blood Pressure Meter
                                </h1>
                                <h2 class="hero-heading" data-ani="slideinup" data-ani-delay="0.4s">Get <span
                                        class="text-theme">25%</span> Off, Hurry Up!</h2>
                                <p class="hero-text" data-ani="slideinup" data-ani-delay="0.5s">Using a 5 layers
        ...
        <div class="hero-thumb-wrap">
            <div class="hero-thumb" data-slider-tab="#heroSlide1">
                <div class="tab-btn active"><img src="assets/img/hero/hero_thumb_1_1.png" alt="Image"></div>
                <div class="tab-btn"><img src="assets/img/hero/hero_thumb_1_2.png" alt="Image"></div>
                <div class="tab-btn"><img src="assets/img/hero/hero_thumb_1_3.png" alt="Image"></div>
            </div>
        </div>
    </div>
    <section class="space">
        <div class="container">
            <div class="feature-list-wrap">
                <div class="feature-list">
                    <div class="box-icon"><img src="assets/img/icon/shop_feature_1.svg" alt="icon"></div>
                ...
                <div class="feature-list">
                    <div class="box-icon"><img src="assets/img/icon/shop_feature_2.svg" alt="icon"></div>
                    <div class="media-body">
                ...
                <div class="feature-list-line"></div>
                <div class="feature-list">
                    <div class="box-icon"><img src="assets/img/icon/shop_feature_3.svg" alt="icon"></div>
                    <div class="media-body">
                ...
                <div class="feature-list-line"></div>
                <div class="feature-list">
                    <div class="box-icon"><img src="assets/img/icon/shop_feature_4.svg" alt="icon"></div>
                    <div class="media-body">
        ...
        <div class="container z-index-common">
            <div class="row gy-30 justify-content-center">
                <div class="col-xl-4 col-md-6">
                    <div class="offer-card mega-hover" data-bg-src="assets/img/bg/cta_bg_1_1.jpg"><span
                            class="h6 box-subtitle">GET UP TO 26%</span>
                        <h3 class="box-title">Pressure Metter</h3>
                        <p class="price">$80.00 - <del>$120.00</del></p><a href="shop-details.html"
                            class="th-btn btn-sm style4">Shop Now</a>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="offer-card mega-hover" data-bg-src="assets/img/bg/cta_bg_1_2.jpg"><span
                            class="h6 box-subtitle">GET UP TO 20%</span>
                        <h3 class="box-title">Capsule Medicine</h3>
                        <p class="price">$80.00 - <del>$100.00</del></p><a href="shop-details.html"
                            class="th-btn btn-sm style2">Shop Now</a>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="offer-card mega-hover" data-bg-src="assets/img/bg/cta_bg_1_3.jpg"><span
                            class="h6 box-subtitle">GET UP TO 26%</span>
                        <h3 class="box-title">Surgical Gloves</h3>
                        <p class="price">$80.00 - <del>$120.00</del></p><a href="shop-details.html"
                            class="th-btn btn-sm">Shop Now</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-md-between justify-content-center align-items-center">
                ...
                <div class="col-md-auto mt-n3 mt-md-0">
                    <div class="sec-btn">
                        <div class="icon-box"><button data-slider-prev="#catSlide1"
                                class="slider-arrow icon-sm default"><i class="far fa-arrow-left"></i></button> <button
                                data-slider-next="#catSlide1" class="slider-arrow icon-sm default"><i
                                    class="far fa-arrow-right"></i></button></div>
                    </div>
                </div>
            </div>
            <div class="swiper th-slider" id="catSlide1"
                data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"400":{"slidesPerView":"2"},"768":{"slidesPerView":"4"},"992":{"slidesPerView":"5"},"1200":{"slidesPerView":"6"}}}'>
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="category-card">
                            <div class="box-icon"><img src="assets/img/icon/category_card_1.png" alt="Image"></div>
                            <h3 class="box-title"><a href="shop.html">Blood Pressure</a></h3>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="category-card">
                            <div class="box-icon"><img src="assets/img/icon/category_card_2.png" alt="Image"></div>
                            <h3 class="box-title"><a href="shop.html">Hospital Equipment</a></h3>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="category-card">
                            <div class="box-icon"><img src="assets/img/icon/category_card_3.png" alt="Image"></div>
                            <h3 class="box-title"><a href="shop.html">Pharmacy Medicine</a></h3>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="category-card">
                            <div class="box-icon"><img src="assets/img/icon/category_card_4.png" alt="Image"></div>
                            <h3 class="box-title"><a href="shop.html">Surgical Gloves</a></h3>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="category-card">
                            <div class="box-icon"><img src="assets/img/icon/category_card_5.png" alt="Image"></div>
                            <h3 class="box-title"><a href="shop.html">Surgical Mask</a></h3>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="category-card">
                            <div class="box-icon"><img src="assets/img/icon/category_card_6.png" alt="Image"></div>
                            <h3 class="box-title"><a href="shop.html">Dental Equipment</a></h3>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="category-card">
    ...
    <section class="space" id="shop-sec">
        <div class="container">
            <div class="row justify-content-lg-between justify-content-center align-items-center">
                ...
                <div class="col-lg-auto">
                    <div class="filter-menu filter-menu-active"><button data-filter="*" class="th-btn active"
                            type="button">All Products</button> <button data-filter=".cat1" class="th-btn"
                            type="button">Medicine</button> <button data-filter=".cat2" class="th-btn"
                            type="button">Equipment</button> <button data-filter=".cat3" class="th-btn"
                            type="button">Accessories</button></div>
                </div>
            </div>
            <div class="row gy-40 filter-active">
                <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat3">
                    <div class="th-product product-grid">
                        ...
                        <div class="product-content"><a href="shop-details.html"
                            ...
                            <h3 class="product-title"><a href="shop-details.html">Surgery Hands Gloves</a></h3><span
                                class="price">$20.00 - <del>$30.00</del></span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat1">
                    <div class="th-product product-grid">
                        ...
                        <div class="product-content"><a href="shop-details.html" class="product-category">Medicine</a>
                            <h3 class="product-title"><a href="shop-details.html">D-Ribose Drug Medicine</a></h3><span
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat2">
                    <div class="th-product product-grid">
                        ...
                        <div class="product-content"><a href="shop-details.html" class="product-category">Equipment</a>
                            <h3 class="product-title"><a href="shop-details.html">CAD Dentistry Prosthesis</a></h3><span
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat3">
                    <div class="th-product product-grid">
                        ...
                        <div class="product-content"><a href="shop-details.html"
                                class="product-category">Accessories</a>
                            <h3 class="product-title"><a href="shop-details.html">Surgery Safety Mask</a></h3><span
                                class="price">$08.85 - <del>$16.99</del></span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat3">
                    <div class="th-product product-grid">
                        ...
                        <div class="product-content"><a href="shop-details.html"
                                class="product-category">Accessories</a>
                            <h3 class="product-title"><a href="shop-details.html">Infrared Thermometers</a></h3><span
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat2">
                    <div class="th-product product-grid">
                        ...
                        <div class="product-content"><a href="shop-details.html" class="product-category">Equipment</a>
                            <h3 class="product-title"><a href="shop-details.html">Drug Inhaler Nebulizers</a></h3><span
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat2 cat1">
                    <div class="th-product product-grid">
                        ...
                        <div class="product-content"><a href="shop-details.html" class="product-category">Medicine</a>
                            <h3 class="product-title"><a href="shop-details.html">Paracetamol Drug</a></h3><span
                                class="price">$08.85 -<del>$16.99</del></span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6 filter-item cat3">
                    <div class="th-product product-grid">
                        ...
                        <div class="product-content"><a href="shop-details.html"
                                class="product-category">Accessories</a>
                            <h3 class="product-title"><a href="shop-details.html">Blood Pressure Machine</a></h3><span
                                class="price">$30.85</span>
                        </div>
                    </div>
                </div>
    ...
    <section class="overflow-hidden">
        <div class="container-fluid px-xl-0 z-index-common">
            <div class="row gy-30">
                <div class="col-xl-8">
                    <div class="offer-block mega-hover" data-bg-src="assets/img/bg/cta_bg_4_1.jpg"><span
                            class="h6 box-subtitle text-white">Get Up to <span class="text-theme">50%</span> OFF</span>
                        <h2 class="sec-title text-white">Blood Pressure Medicine</h2>
                        <p class="box-text text-white">Free Shipping on Order Over $49</p><a href="shop-details.html"
                            class="th-btn">Shop Now</a>
                ...
                <div class="col-xl-4">
                    <div class="offer-block2 mega-hover" data-bg-src="assets/img/bg/cta_bg_4_2.jpg"><span
                            class="h6 box-subtitle">Get Up to <span class="text-theme2">50%</span> OFF</span>
                        <h3 class="sec-title">On All Covid-19 Vaccine</h3>
                        <p class="box-text text-title">Free Shipping on Order Over $49</p><a href="shop-details.html"
                            class="th-btn style4">Shop Now</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-9">
                    <div class="row justify-content-md-between justify-content-center align-items-center">
                        ...
                        <div class="col-md-auto mt-n3 mt-md-0">
                            <div class="sec-btn"><a href="shop.html" class="th-btn style-smoke">VIEW ALL PRODUCTS</a>
                            </div>
                        </div>
                    </div>
                    <div class="row gy-40">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content"><a href="shop-details.html"
                                        class="product-category">Medicine</a>
                                    <h3 class="product-title"><a href="shop-details.html">D-Ribose Drug Medicine</a>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content"><a href="shop-details.html"
                                        class="product-category">Equipment</a>
                                    <h3 class="product-title"><a href="shop-details.html">CAD Dentistry Prosthesis</a>
                                    </h3><span class="price">$96.85</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 mt-40 mt-xl-0">
                    <div class="offer-grid mega-hover text-center text-xl-start"
                        data-bg-src="assets/img/bg/cta_bg_2_1.jpg"><span class="h6 box-subtitle text-white">EXRTA 9%
                            SAVING ON ORDER</span>
                        <p class="price text-white">$80.00 - <del>$120.00</del></p>
                        <h3 class="box-title text-white">For Weight Gain</h3><a href="shop-details.html"
                            class="th-btn btn-sm style4">Shop Now</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row gy-30">
                <div class="col-lg-6">
                    <div class="offer-box mega-hover" data-bg-src="assets/img/bg/cta_bg_3_1.jpg">
                        <h3 class="box-title">Week End Sale<span class="text-theme2">!</span></h3><span
                            class="h6 box-subtitle">Buy Your Best Healthcare Equipment & Medicines. <span
                                class="text-theme2">Hurry Up!</span></span> <a href="shop-details.html"
                            class="th-btn btn-sm">Shop Now</a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="offer-box mega-hover" data-bg-src="assets/img/bg/cta_bg_3_2.jpg">
                        <h3 class="box-title">Special Offer Now<span class="text-theme">!</span></h3><span
                            class="h6 box-subtitle">Buy Your Best Healthcare Equipment & Medicines. <span
                                class="text-theme">Hurry Up!</span></span> <a href="shop-details.html"
                            class="th-btn btn-sm style4">Shop Now</a>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-3 mb-40 mb-xl-0">
                    <div class="offer-grid mega-hover text-center text-xl-start"
                        data-bg-src="assets/img/bg/cta_bg_2_2.jpg"><span class="h6 box-subtitle">FREE SHIPPING AND
                            MORE</span>
                        <p class="box-text text-theme2">Curbside Delivery</p>
                        <h3 class="box-title">Medical Gadget</h3><a href="shop-details.html"
                            class="th-btn btn-sm style4">Shop Now</a>
                    </div>
                </div>
                <div class="col-xl-9">
                    <div class="row justify-content-md-between justify-content-center align-items-center">
                        <div class="col-md">
                            <h3 class="sec-title has-line">Top Equipment’s</h3>
                        </div>
                        <div class="col-md-auto mt-n3 mt-md-0">
                            <div class="sec-btn"><a href="shop.html" class="th-btn style-smoke">VIEW ALL PRODUCTS</a>
                            </div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="testi-card">
                            ...
                            <div class="box-quote"><img src="assets/img/icon/quote_1.svg" alt="Icon"></div>
                            ...
                            <div class="box-profile">
                                ...
                                <div class="box-content">
                                    <h3 class="box-title">Pelican Steve</h3><span class="box-desig">Neurologist</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="testi-card">
                            ...
                            <div class="box-profile">
                                ...
                                <div class="box-content">
                                    <h3 class="box-title">Alexa Milton</h3><span
                                        class="box-desig">Physiotherapist</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container th-container">
                <div class="swiper th-slider" id="brandSlider1"
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="brand-box"><img src="assets/img/brand/brand_1_8.svg" alt="Brand Logo"></div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brand-box"><img src="assets/img/brand/brand_1_1.svg" alt="Brand Logo"></div>
                        </div>
            ...
            <div class="row gy-40">
                    ...
                    <div class="row gy-4">
                        <div class="col-md-6">
                            <div class="th-product list-view">
                                <div class="product-img"><img src="assets/img/product/product_list_1.jpg"
                                        alt="Product Image">
                        ...
                        <div class="col-md-6">
                            <div class="th-product list-view">
                                <div class="product-img"><img src="assets/img/product/product_list_2.jpg"
                                        alt="Product Image">
                                    <div class="actions"><a href="cart.html" class="icon-btn"><i
                                                class="far fa-cart-plus"></i></a></div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="th-product list-view">
                                <div class="product-img"><img src="assets/img/product/product_list_3.jpg"
                                        alt="Product Image">
                                    <div class="actions"><a href="cart.html" class="icon-btn"><i
                                                class="far fa-cart-plus"></i></a></div>
                                </div>
                                <div class="product-content"><a href="shop-details.html"
                                        class="product-category">Equipment</a>
                                    <h3 class="product-title"><a href="shop-details.html">Dentist Chair</a></h3><span
                                        class="price">$96.85</span>
                                    <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span>Rated
                                            <strong class="rating">5.00</strong> out of 5 based on <span
                                                class="rating">1</span> customer rating</span></div>
                        ...
                        <div class="col-md-6">
                            <div class="th-product list-view">
                                <div class="product-img"><img src="assets/img/product/product_list_4.jpg"
                                        alt="Product Image">
                                    <div class="actions"><a href="cart.html" class="icon-btn"><i
                                                class="far fa-cart-plus"></i></a></div>
                                </div>
                ...
                <div class="col-xl-6">
                    ...
                    <div class="row gy-4">
                        <div class="col-md-6">
                            <div class="th-product list-view">
                                <div class="product-img"><img src="assets/img/product/product_list_5.jpg"
                                        alt="Product Image">
                                    <div class="actions"><a href="cart.html" class="icon-btn"><i
                                                class="far fa-cart-plus"></i></a></div>
                                </div>
                                <div class="product-content"><a href="shop-details.html"
                                        class="product-category">Equipment</a>
                                    <h3 class="product-title"><a href="shop-details.html">Presser Meter</a></h3><span
                                        class="price">$32.85</span>
                                    <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span>Rated
                                            <strong class="rating">5.00</strong> out of 5 based on <span
                                                class="rating">1</span> customer rating</span></div>
                        ...
                        <div class="col-md-6">
                            <div class="th-product list-view">
                                <div class="product-img"><img src="assets/img/product/product_list_6.jpg"
                                        alt="Product Image">
                                    <div class="actions"><a href="cart.html" class="icon-btn"><i
                                                class="far fa-cart-plus"></i></a></div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="th-product list-view">
                                <div class="product-img"><img src="assets/img/product/product_list_7.jpg"
                                        alt="Product Image">
                                    <div class="actions"><a href="cart.html" class="icon-btn"><i
                                                class="far fa-cart-plus"></i></a></div>
                                </div>
                                <div class="product-content"><a href="shop-details.html"
                                        class="product-category">Equipment</a>
                                    <h3 class="product-title"><a href="shop-details.html">N95-Face Mask</a></h3><span
                        ...
                        <div class="col-md-6">
                            <div class="th-product list-view">
                                <div class="product-img"><img src="assets/img/product/product_list_8.jpg"
                                        alt="Product Image">
                                    <div class="actions"><a href="cart.html" class="icon-btn"><i
                                                class="far fa-cart-plus"></i></a></div>
                                </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="blog-box">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta"><a href="blog.html"><i class="fal fa-user"></i>By Mediax</a> <a
                                    href="blog.html"><i class="fal fa-calendar"></i>15 March, 2024</a></div>
                            <h3 class="box-title"><a href="blog-details.html">How Business Is Taking Over & What to Do
                                    About It</a></h3><a href="blog-details.html" class="th-btn btn-sm">Read More</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="blog-box">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta"><a href="blog.html"><i class="fal fa-user"></i>By Mediax</a> <a
                                    href="blog.html"><i class="fal fa-calendar"></i>16 March, 2024</a></div>
                            <h3 class="box-title"><a href="blog-details.html">Health vs. Wealth Navigate Business in
                                    Medicine</a></h3><a href="blog-details.html" class="th-btn btn-sm">Read More</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="blog-box">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta"><a href="blog.html"><i class="fal fa-user"></i>By Mediax</a> <a
                                    href="blog.html"><i class="fal fa-calendar"></i>17 March, 2024</a></div>
                            <h3 class="box-title"><a href="blog-details.html">Preserving Care Strategy Amidst Food
                                    Changes</a></h3><a href="blog-details.html" class="th-btn btn-sm">Read More</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="newsletter-widget">
                                ...
                                <form action="#" class="newsletter-form">
                                    <div class="form-group"><input class="form-control" type="email"
                                            placeholder="Enter Email" required=""></div><button type="submit"
                                        class="simple-icon"><i class="fa-solid fa-paper-plane"></i></button>
                                </form>
                                <div class="form-group"><input type="checkbox" id="checkbox" name="checkbox"> <label
                                        for="checkbox">I agree with the terms & conditions</label></div>
                                <div class="btn-group"><a href="https://play.google.com/" class="img-btn"><img
                                            src="assets/img/normal/apple_store.png" alt="icon"> </a><a
                                        href="https://play.google.com/" class="img-btn"><img
                                            src="assets/img/normal/play_store.png" alt="icon"></a></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from html.themeholy.com/mediax/demo/home-medical-shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Feb 2024 10:30:16 GMT -->
