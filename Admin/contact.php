...
if (strlen($_SESSION['adminid']==0)) {
  header('location:logout.php');
    ...
    $sql = "SELECT * FROM contact_customers order by created_at desc";
...
<body>
    ...
    <div class="container-fluid">
        <div class="main-content d-flex flex-column">
            ...
            <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
                <!-- <h3 class="mb-sm-0 mb-1 fs-18">Contact Upload</h3> -->
                <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
                    ...
                    <li>
                        <span class="fw-semibold fs-14 heading-font text-dark dot ms-2">Contact Registration</span>
                    </li>
                </ul>
            </div>
                        ...
                        <ul class="nav nav-tabs border-0 courses-tab justify-content-center justify-content-sm-start mb-3 mb-sm-0"
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link fs-18 fw-semibold border-0 active" id="enrolled-tab"
                                    ...
                                    aria-controls="enrolled-tab-pane" aria-selected="true">Contact</button>
                            </li>
                    ...
                    <div class="tab-content" id="myTabContent">
                                    ...
                                    <table class="table align-middle" id="myTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Get Back Message</th>
                        ...
                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <span><?php echo $row['backmessage']; ?></span>
                                                </td>
                                                ...
                                                <td>
                                                    <a class="dropdown-item"
                                                        href="send-message-back.php?id=<?php echo $row['id']; ?>">
    ...
    $(document).ready(function() {
        $('#id-for-send-mail').submit(function(e) {
            ...
            var message = $('#message-patient').val().trim();
            var id = $('#message-patient').val().trim();
