    ...
    <div class="container-fluid">
        <div class="main-content d-flex flex-column">
            ...
            <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
                <!-- <h3 class="mb-sm-0 mb-1 fs-18">Appointment Upload</h3> -->
                <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
                    ...
                    <li>
                        <span class="fw-semibold fs-14 heading-font text-dark dot ms-2">Appointment Registration</span>
                    </li>
                </ul>
            </div>
                        ...
                        <ul class="nav nav-tabs border-0 courses-tab justify-content-center justify-content-sm-start mb-3 mb-sm-0"
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link fs-18 fw-semibold border-0 active" id="enrolled-tab"
                                    ...
                                    aria-controls="enrolled-tab-pane" aria-selected="true">Appointment</button>
                            </li>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        ?>
                                            <tr>
                                                ...
                                                <?php
                                                $doctors = $row['doctors'];
                                                $sql = "SELECT * FROM `doctors` WHERE id='$doctors'";
                                                $result_new = $con->query($sql);
                                                if ($result_new->num_rows > 0) {
                                                    
                                                    while($row_new = $result_new->fetch_assoc()) {
                                                        echo "<span>" . $row_new["fname"] . "</span>";
