...
<head>
    ...
    <title>Mediax - Health & Medical HTML Template - Shop Details</title>
        ...
        <div class="container">
                    ...
                    <div class="product-about">
                        ...
                        <div class="product-rating">
                            <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span
                                ...
                                href="shop-details.php" class="woocommerce-review-link">(<span class="count">4</span>
                                customer reviews)</a>
                        </div>
                        <p class="text">Surgery Hands Gloves are high-quality, disposable gloves designed specifically
                            for surgical procedures. Crafted from premium materials, these gloves provide a reliable
                            barrier against contaminants, ensuring a sterile environment for surgical teams. The gloves
                            offer a comfortable and secure fit, promoting dexterity and tactile sensitivity.</p>
                        ...
                        <div class="actions">
                            ...
                            <button class="th-btn">Add to Cart</button> <a href="wishlist.php" class="icon-btn"><i
                                    class="far fa-heart"></i></a>
                        </div>
                        <div class="product_meta"><span class="sku_wrapper">SKU: <span
                                    class="sku">Surgery-Hands-Gloves</span></span> <span class="posted_in">Category: <a
                                    href="shop.php">Accessories</a></span> <span>Tags: <a
                                    href="shop.php">Medical</a><a href="shop.php">Accessories</a></span></div>
                    </div>
                </div>
            </div>
            ...
            <div class="tab-content" id="productTabContent">
                <div class="tab-pane fade" id="description" role="tabpanel" aria-labelledby="description-tab">
                    <p>Surgery Hands Gloves are meticulously engineered to meet the exacting demands of surgical
                        procedures, offering a crucial layer of protection for healthcare professionals. Crafted from
                        premium latex or synthetic materials, these gloves ensure an impermeable barrier against
                        contaminants, maintaining a sterile environment essential for surgical precision. The anatomical
                        design and advanced manufacturing techniques provide an exceptional fit, allowing surgeons and
                        healthcare staff unparalleled dexterity and tactile sensitivity. This enables precise movements
                        during intricate procedures, fostering optimal control and minimizing the risk of accidental
                        exposure.</p>
                    <p>These gloves undergo rigorous quality control measures to comply with industry standards,
                        assuring reliability and consistency in performance. The textured surface enhances grip,
                        reducing the likelihood of slippage and facilitating confident handling of surgical instruments.
                        Whether in general surgery, orthopedics, or other specialized fields, Surgery Hands Gloves
                        instill confidence and assurance, contributing to the overall safety and success of surgical
                        interventions. Choose Surgery Hands Gloves for a dependable solution that prioritizes both the
                        safety of healthcare professionals and the well-being of patients.</p>
                    <p>In addition to their functional excellence, Surgery Hands Gloves prioritize user comfort. The
                        hypoallergenic materials reduce the risk of skin irritations, ensuring a comfortable wearing
                        experience throughout extended surgical procedures. The gloves are available in various sizes to
                        accommodate diverse hand shapes, promoting a customized and secure fit. Elevate your surgical
                        practice with the assurance of Surgery Hands Gloves — a reliable and indispensable choice for
                        those committed to excellence in the operating room.</p>
                </div>
                                    ...
                                    <div class="th-post-comment">
                                        ...
                                        <div class="comment-content">
                                            <h4 class="name">Adam Jhon</h4><span class="commented-on"><i
                                                    class="far fa-calendar"></i>22 April, 2023</span>
                                            <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span
                                    ...
                                    <div class="th-post-comment">
                                        ...
                                        <div class="comment-content">
                                            <h4 class="name">Jusctin Dacon</h4><span class="commented-on"><i
                                                    class="far fa-calendar"></i>26 April, 2023</span>
                                            <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span
                                                    style="width:100%">Rated <strong class="rating">5.00</strong> out of
                                                    5 based on <span class="rating">1</span> customer rating</span>
                                            </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content"><a href="shop-details.php"
                                        class="product-category">Accessories</a>
                                    <h3 class="product-title"><a href="shop-details.php">Surgery Hands Gloves</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content"><a href="shop-details.php"
                                    ...
                                    <h3 class="product-title"><a href="shop-details.php">D-Ribose Drug Medicine</a>
                        ...
                        <div class="swiper-slide">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content"><a href="shop-details.php"
                                    ...
                                    <h3 class="product-title"><a href="shop-details.php">CAD Dentistry Prosthesis</a>
                        ...
                        <div class="swiper-slide">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content"><a href="shop-details.php"
                                        class="product-category">Accessories</a>
                                    <h3 class="product-title"><a href="shop-details.php">Surgery Safety Mask</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content"><a href="shop-details.php"
                                        class="product-category">Accessories</a>
                                    <h3 class="product-title"><a href="shop-details.php">Infrared Thermometers</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content"><a href="shop-details.php"
                                        class="product-category">Equipment</a>
                                    <h3 class="product-title"><a href="shop-details.php">Drug Inhaler Nebulizers</a>
                        ...
                        <div class="swiper-slide">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content"><a href="shop-details.php"
                                        class="product-category">Medicine</a>
                                    <h3 class="product-title"><a href="shop-details.php">Paracetamol Drug</a></h3><span
                        ...
                        <div class="swiper-slide">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content"><a href="shop-details.php"
                                        class="product-category">Accessories</a>
                                    <h3 class="product-title"><a href="shop-details.php">Blood Pressure Machine</a>
                                    </h3><span class="price">$30.85</span>
                                </div>
                            </div>
                        </div>
